...
@WebMvcTest(GetValueForNewHealthcareInstitutionController.class)
public class GetValueForNewHealthcareInstitutionControllerTest {
    ...
    public void returnsValueToCreateNewHealthInstitution() throws Exception {
        when(getValueForNewHealthcareInstitutionPresenter.get())
